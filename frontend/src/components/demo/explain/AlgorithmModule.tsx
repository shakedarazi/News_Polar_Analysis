        ...
        {w ? (
          <div className="flex flex-col gap-4">
            <p className="text-[18px] leading-relaxed text-[var(--dk-ink-2)]">
              כל כתבה נחתכת למשפטים, וכל משפט נספר מול מילון קבוע של מילים לפי
              נושא. אותו טקסט יחזיר את אותו מספר גם בעוד שנה, גם בלי חיבור
              לאינטרנט, ובעלות אפס.
            </p>
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <Node
                title="מודל שפה"
                tone="accent"
                sub="רואה מסגור וקול · הספק מעדכן גרסה והמספרים זזים · דורש אימות"
              />
            </div>
            <p className="text-[18px] leading-relaxed text-[var(--dk-ink-2)]">
              לכל מדידה נשמרת חתימה של המילון ששימש אותה. אם מילה נוספת למילון,
              המספרים הישנים מזוהים ככאלה שנמדדו בגרסה אחרת — ואי אפשר להשוות
              אותם בטעות לחדשים.
            </p>
            <p className="text-[18px] leading-relaxed text-[var(--dk-ink-2)]">
              אין כאן מפתח API, אין ספק חיצוני ואין מה שייפול. השכבה רצה על כל
              הקורפוס בכל בנייה מחדש, ולכן אפשר לשנות החלטה ולמדוד הכל מחדש בלי
              לשאול קודם כמה זה יעלה.
            </p>
            <p className="text-[18px] leading-relaxed text-[var(--dk-ink-2)]">
