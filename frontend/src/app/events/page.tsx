...
async function EventsContent({
  ...
  return (
    <div className="space-y-6">
      ...
      {events.length === 0 ? (
        <div className="card">
          <EmptyState message="לא זוהו אירועים התואמים לסינון שנבחר. אירוע מזוהה כשלפחות שתי כתבות דומות (נושא, זמן פרסום קרוב וכותרת דומה) מכוסות במערכת." />
        </div>
      ) : (
        <>
    ...
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6">
      <section>
        ...
        <p className="mt-1 text-slate-600 dark:text-slate-300">
          כתבות דומות מכמה מקורות, מקובצות אוטומטית לפי נושא, סמיכות זמן פרסום ודמיון כותרות —
          ומוצגות כאירוע יחיד עם ציר זמן.
        </p>
      </section>
      <Suspense
