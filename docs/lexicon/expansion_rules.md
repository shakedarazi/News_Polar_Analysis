...
- [1. Purpose of Expansion](#1-purpose-of-expansion)
- [2. Base Lexicon](#2-base-lexicon)
- [3. Prefix Expansion Rules](#3-prefix-expansion-rules)
- [4. Combined Prefix Rule (Limited)](#4-combined-prefix-rule-limited)
- [5. Minimum Length Constraint](#5-minimum-length-constraint)
- [6. Conflict Resolution](#6-conflict-resolution)
- [7. Output of Expansion](#7-output-of-expansion)
- [8. Validation Rules](#8-validation-rules)
- [9. Expansion and Versioning](#9-expansion-and-versioning)
