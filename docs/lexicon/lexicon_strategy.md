...
- [1. Purpose of the Lexicon](#1-purpose-of-the-lexicon)
- [2. Lexicon Types](#2-lexicon-types)
- [3. Chosen Approach: Expanded Lexicon (Approach A)](#3-chosen-approach-expanded-lexicon-approach-a)
- [4. Why Expanded Lexicon Was Chosen](#4-why-expanded-lexicon-was-chosen)
- [5. Runtime Matching Rules](#5-runtime-matching-rules)
- [6. Versioning Requirements](#6-versioning-requirements)
- [7. Future Strategy (Not Enabled)](#7-future-strategy-not-enabled)
