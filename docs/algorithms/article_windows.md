...
- [1. Purpose of Window-Based Analysis](#1-purpose-of-window-based-analysis)
- [2. Definition of a Window](#2-definition-of-a-window)
- [3. Sentence Splitting Rules](#3-sentence-splitting-rules)
- [4. Chunking Long Sentences](#4-chunking-long-sentences)
- [5. Tokenization](#5-tokenization)
- [6. Category Matching](#6-category-matching)
- [7. Feature Computation per Window](#7-feature-computation-per-window)
- [8. Active Category Tracking](#8-active-category-tracking)
- [9. Dominance Metric](#9-dominance-metric)
